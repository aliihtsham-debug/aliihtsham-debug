...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Content — using CSS 3D layered depth instead of MouseParallax */}
      <div
        className="relative z-10 max-w-5xl mx-auto px-6 text-center layered-depth"
      ...
      >
        ...
        {/* Main heading with 3D layered depth */}
        <motion.h1
          className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-6"
          style={{ transformStyle: "preserve-3d" }}
        >
          <motion.span
            className="text-text-primary inline-block layer-front"
          ...
          <motion.span
            className="text-gradient-violet inline-block layer-front"
            initial={{ y: 60, opacity: 0, rotateX: -40 }}
            animate={{ y: 0, opacity: 1, rotateX: 0 }}
        ...
        >
          <AnimatePresence mode="wait">
            <motion.p
              ...
              className="text-lg md:text-xl lg:text-2xl text-text-secondary font-light layer-mid"
            >
        ...
        >
          {[
            ...
            <div key={stat.label} className="text-center layer-mid">
